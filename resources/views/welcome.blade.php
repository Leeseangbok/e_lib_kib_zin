<x-app-layout>
    ...
    <div class="pb-12">
        <div class="max-w-7xl mx-auto h-full sm:px-6 lg:px-8">
            <div
                class="relative shadow-lg bg-gray-300 rounded-b-lg h-[500px] flex flex-col justify-center items-center p-8 mb-12 text-center bg-cover bg-center bg-no-repeat"
                ...
                <div class="relative z-10">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('books.index') }}" class="inline-block rounded-lg bg-indigo-600 px-5 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Browse All Books</a>
                        <a href="{{ route('categories.index') }}" class="ml-4 inline-block rounded-lg bg-gray-200 px-5 py-3 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-300">Browse Categories</a>
                    </div>
                </div>
            </div>
