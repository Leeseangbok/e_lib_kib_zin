        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                                ...
                                <div class="flex flex-col bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                                    ...
                                    <div class="p-4 flex flex-col flex-grow">
                                        ...
                                        <div class="mt-auto pt-4">
                                            <a href="{{ route('books.show', $book) }}" class="text-indigo-600 hover:text-indigo-800">View Details &rarr;</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        <p>Your library is empty. <a href="{{ route('books.index') }}" class="text-indigo-600 hover:underline">Browse books</a> to add some!</p>
                    @endif
                </div>
            </div>
        </div>
